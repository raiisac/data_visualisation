...
<main bind:clientWidth={width} bind:clientHeight={height} style={`position: absolute; left: 5px; top: 285px;`}>
...
<div class="analysis-div" style={`border:1px solid black; overflow: hidden; position: absolute; width: 400px; height: 707px; left: 912px; top: 63px;`}>
	<div class="filter-sub-div-0" id="Header" style="height: 40px; width: 100%; top: 0px; border-bottom: 1px solid black; box-sizing: border-box;">
